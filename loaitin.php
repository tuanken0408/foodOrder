...
$menu = $tintucs['menu'];
$title = $tintucs['title'];
$thanhphantrang = $tintucs['thanhphantrang'];
$alias = $tintucs['alias'];
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <ul>
                            ...
                            foreach ($loaitin as $loai) {
                                ...
                                <li class="list-group-item">
                                    <a href="loaitin.php?alias=<?php echo $tenkhongdau?>&id_loai=<?php echo $id ?>"><?php echo $ten ?></a>
                                </li>
                                <?php
                            }
                            ?>
                ...
                foreach ($tintuc as $tin){
                    ...
                    <div class="row-item row">
                        <div class="col-md-3">
                            ...
                            <a href="chitiet.php?loai_tin=<?php echo $alias->TenKhongDau ?>&alias=<?php echo $tin->TieuDeKhongDau?>&id_tin=<?php echo $tin->id ?>">
                                <br>
                        ...
                        <div class="col-md-9" >
                            ...
                            <a class="btn btn-primary" href="chitiet.php?loai_tin=<?php echo $alias->TenKhongDau ?>&alias=<?php echo $tin->TieuDeKhongDau?>&id_tin=<?php echo $tin->id ?>">Xem chi tiết<span class="glyphicon glyphicon-chevron-right"></span></a>
                        </div>
                        <div class="break"></div>
                    </div>
                <?php
